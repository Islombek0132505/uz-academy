        ...
        <>
            <div className="grid grid-cols-4 max-md:grid-cols-2 px-4 py-6 bg-background mt-4 rounded-3xl shadow-lg">
                <div className="col-span-2 self-center">
                    <h1 className="text-3xl font-medium"><span className="text-green-500">Til</span> o'rganing. Ilhomlaning. <span className="text-green-500">Yangi dunyo</span> ochilsin!</h1>
            ...
            <div className="mt-12">
                ...
                <p className="text-muted-foreground text-lg mt-2">Til o'rganing va shu bilan yangi dunyo kashf qiling</p>
