...
function ConfessionPresident() {
    return (
        <div className="max-w-6xl mx-auto mt-20 container">
            <h1 className="text-5xl font-black">Prezident e’tirofi</h1>
