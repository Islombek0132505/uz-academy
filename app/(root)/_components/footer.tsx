                ...
                <div className="px-4">
                    ...
                    <div className="grid grid-cols-12 my-16 max-md:my-10">
                        ...
                        <div className="col-span-6 text-white pr-6 max-md:col-span-12 max-md:mt-12">
                            ...
                            <p className="text-lg mt-6 max-md:text-base">Hali ham savollaringiz bormi yoki kurs haqida qaror qabul qila olmayapsizmi? Unda sizga bog‘lanib batafsil ma&rsquo;lumot beramiz.</p>
                        </div>
