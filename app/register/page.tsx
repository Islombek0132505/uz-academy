    ...
    return (
        <div className="w-full h-full p-6">
            <div className="flex justify-center items-center">
                <div className="grid grid-cols-2 max-w-6xl container mx-auto">
                    <div className="col-span-1 w-3/4 mx-auto py-12">
                        <div className="border-[3px] border-slate-200/50 px-10 py-12 self-center">
                    ...
                    <Image
                        ...
                        width={500}
                        height={500}
                        className="object-contain self-center col-span-1 pl-10"
                    />
                </div>
            </div>
        </div>
